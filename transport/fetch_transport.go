...
func FetchDecodeRequest(ctx context.Context, r *http.Request) (interface{}, error) {
...
func FetchEncodeResponse(ctx context.Context, w http.ResponseWriter, response interface{}) error {
	var body []byte
...
func FetchEndpoint(svc services.DoReqServices, dbConn lib.DbConnection) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		req, ok := request.(dt.DoRequest)
		if ok {

			return svc.GoFetch(ctx, req, dbConn), nil
